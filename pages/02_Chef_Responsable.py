...
from repos import chef_responsable_repo as repo
...
row = pick_row_by_id("Pick a row", rows, id_key="id", display_key="nombre", key="pick_chef")
if row:
    col1, col2 = st.columns(2)

    with col1:
        with st.form("edit_chef"):
    ...
    with col2:
        if confirm_box("confirm_del_chef", "I understand this will delete the row"):
